...
function Auth() {
  ...
  return (
    <div className="flex items-start justify-center pt-10 px-4 bg-gray-100 min-h-screen">
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl p-6 sm:p-8 space-y-6 bg-white rounded shadow-md">
